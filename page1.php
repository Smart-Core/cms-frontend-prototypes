    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $.magnificPopup.open({
                ...
                overflowY: 'scroll',
                items: {
//                    src: '<?php //include_once ('/test_ajax_modal.php'); ?>',
                    src: '/test_ajax_modal.php',
                    type: 'ajax'
                },
                callbacks: {
                    open: function() {
...
<div class="container">
    <div class="row-fluid">
        ...
        <div class="span9">
            ...
            <a id="test_ajax_modal" href="<?php $_SERVER['PHP_SELF'] ?>?act=1">test_ajax_modal</a>
